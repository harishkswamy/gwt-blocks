...
public class MessageBox extends DialogBox
{
    ...
    private static final String     INFO_ICON_URL      = "gwtBlocks/images/info.png";
    private static final String     WARNING_ICON_URL   = "gwtBlocks/images/warning.png";
    private static final String     ERROR_ICON_URL     = "gwtBlocks/images/error.png";
